        ...
        <Row className="plot-contents plot-facets">
          ...
          <Col lg="6" md="12" sm="12" xs="12" className="plot-facet">
            ...
            <div className="plot-description-facet">
              ...
              <br />
              <strong>Desmesura: </strong> Sienten fuertes antojos y urgencias
              que no pueden resistir facilmente, aunque saben que es probable
              que se arrepientan más tarde. Tienden a orientarse hacia Placeres
              y recompensas a corto plazo en lugar de a largo plazo.
              <br />
              <strong>Melancolía: </strong> Tienden a reaccionar fuertemente a
